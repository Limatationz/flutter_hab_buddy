...
import '../player/complex/complex_player_add_view.dart';
...
import '../thermostat/thermostat_add_view.dart';
...
import '../weather/weather_add_view.dart';
...
class ItemWidgetFactory {
  ...
  static Future<void> openEditView(BuildContext context, Item item) {
    late final Widget child;
    if (item.type == ItemType.complexPlayer) {
      child = ComplexPlayerAddView(
          roomId: item.roomId!,
  ...
  static Future<bool> openComplexAddView(
