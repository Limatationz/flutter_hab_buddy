...
class WeatherAddView extends StatefulWidget {
  final int roomId;
  final Item? item;
  ...
  @override
  State<WeatherAddView> createState() => _WeatherAddViewState();
}

class _WeatherAddViewState extends State<WeatherAddView> {
            ...
            child: ListView(
              ...
              children: [
                Center(child: SizedBox(
                    ...
                    width: isForecast
                        ? LargeWidthItemWidget.width
                        : MediumWidthItemWidget.width,
