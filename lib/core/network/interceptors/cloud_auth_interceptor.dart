...
class CloudAuthInterceptor implements Interceptor {
  String? _username;
  String? _password;

  CloudAuthInterceptor(Stream<LoginData?> loginDataStream) {
    loginDataStream.listen((tuple) {
      _username = tuple?.cloudLoginData?.username;
      _password = tuple?.cloudLoginData?.password;
    });
  }
